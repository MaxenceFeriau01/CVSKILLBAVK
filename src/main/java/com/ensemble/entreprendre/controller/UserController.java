...
import com.ensemble.entreprendre.dto.*;
...
public class UserController {
	...
	@GetMapping("/all")
	@ApiOperation(value = "Get all users", response = UserCvSkillDto.class, responseContainer = "List")
	public ResponseEntity<List<UserCvSkillDto>> getAllUsers() {
		try {
			List<UserCvSkillDto> users = userService.getAllUsers();
